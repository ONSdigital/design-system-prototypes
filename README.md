...
This is a prototype project that was created using the @ons/prototype-kit package's `create-prototype` command. This prototype uses the ONS design system to render page layouts and components.

Refer to the [prototype kit repository](https://github.com/ONSdigital/prototype-kit) for further information regarding usage of the prototype kit.
...
This project uses [gulp](https://gulpjs.com/) to automate the above commands. The [prototype kit](https://github.com/ONSdigital/prototype-kit) provides default gulp tasks which are used by this repository which are inherited in the `./gulpfile.js` script.
